...
namespace OutSystems.NssAdvanced_Excel {
	...
	public interface IssAdvanced_Excel {
		...
		void MssCell_Write(object ssWorksheet, string ssCellName, int ssCellRow, int ssCellColumn, string ssCellValue, string ssCellType, bool ssPreserveFormat, RCCellFormatRecord ssCellFormat);
		...
		void MssExcel_GetProperties(object ssWorkbook, out RCOfficePropertiesRecord ssProperties);
		...
		void MssExcel_SetProperties(object ssWorkbook, RCOfficePropertiesRecord ssProperties, bool ssIgnoreBlank);
		...
		void MssWorksheet_SetPrintArea(object ssWorksheet, string ssRange);
		...
		void MssWorksheet_SetPageLayout(object ssWorksheet, string ssOrientation, int ssPaperSize, bool ssFitToPage, int ssFitToWidth, int ssFitToHeight);
		...
		void MssWorksheet_SetPrintTitles(object ssWorksheet, string ssRepeatRows, string ssRepeatColumns);
		...
		void MssWorksheet_SetMargins(object ssWorksheet, decimal ssTop, decimal ssBottom, decimal ssLeft, decimal ssRight, decimal ssHeader, decimal ssFooter);
		...
		void MssWorksheet_AddTable(object ssWorksheet, string ssRange, string ssTableName, string ssTableStyle, bool ssShowHeader, bool ssShowFilter, bool ssShowTotal);
		...
		void MssCell_AddHyperlink(object ssWorksheet, string ssCellName, string ssUrl, string ssDisplayText);
